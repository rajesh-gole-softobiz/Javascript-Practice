...
> Click :star:if you like the project. Pull Request are highly appreciated. Follow me [RAJESH GOLE](https://youtube.com/inputoutputcampus) for technical updates.


**Note:** This repository is specific to JavaScript. Please check [ReactJS Questions and Answers](https://github.com/rajesh-gole-softobiz/React-Basics) for core React questions.
